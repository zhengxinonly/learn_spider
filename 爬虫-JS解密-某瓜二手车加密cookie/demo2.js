...
function xredirect1(name, value, url) {
    var date = new Date();
    date.setTime(date.getTime() + 2592000000);
    var expires = "; expires=" + date.toUTCString();
...
var value = anti('WCu7Ie3tuJlyogrPGBK12niVzcj2+H/2gzGUGWMu1oQ=', '443991125942813269');
var name = 'antipas';
var url = '';
